...
> **执行状态（2026-08-14 轮次 2/3，详见 runbook）**：
> - ✅ 已执行并 PASS：E0 全部、E1-1..E1-2、E2-1..E2-4、E3-1..E3-3、E4-1..E4-5、E5-1、E7-3（#129 僵尸自动解除完整闭环）
> - ⚠️ 受限（环境）：E7-5 问题卡片 UI 实测（#125）——服务器 question 工具广播缺陷（backlog #130）
> - ⏳ 未执行：E6-2 冷启动恢复、E7-1/E7-2/E7-4、E8 系列（后续轮次）、V1 协议全套（V1 服务器无模型认证，已登记待办）
