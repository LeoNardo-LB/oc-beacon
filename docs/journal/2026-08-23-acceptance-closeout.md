...
### #192 用户验收（2026-08-23 v6）

用户体验 v6 后确认「好 没什么问题了」——贴边上下滑动手感通过，卡片迁出。实现链：de6afd41（v6 落地+清理）→ 清理提交（TEMP-PROBE 移除）。spec 已标废弃（docs/specs/2026-08-23-fab-swipe-hide-design.md 头部）。
