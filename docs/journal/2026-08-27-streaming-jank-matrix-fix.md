...
## 完结（2026-08-27 深夜，用户验收：「好 现在就比较完美了」）

- #239 关闭。嫌疑②（补偿/fling 竞态）经 744967f4 + e7b23f99 二审根治并经
  用户手感验收；嫌疑③（48ms flush）用户确认无感排除；嫌疑①（服务器 14s
  token 爆发节奏）为服务器侧行为，非 app 缺陷——如日后「蹦字步进」明显，
  换快模型即可对照，无需 app 侧动作。
- 本日修复链总账（6 commit）：0775582d 稳定矩阵 + 58f2b953 #235 卡 +
  7f45ccc6 debug 门禁 + 32f54d04 存档 + 744967f4 竞态 + e7b23f99 二审纠偏
  （+ a282e812 勘误档）。
