...
class FabExpandShiftTest {
    ...
    fun \`overflow pushes down by overflow plus margin\`() {
        // 上拖 800：nodeBottom = 2200, firstItemTop = 1740 ⇒ 溢出 = T(1000) 之上 740px
        val shift = computeFabExpandShiftPx(
            nodeBottomInRoot = 2200f,
            firstItemTopInRoot = 1740f,
            containerHeightPx = 2000f,
            offsetYPx = -800f,
            topMarginPx = margin,
        )
        assertEquals(740f + margin, shift, 0.01f)
    }
    ...
    fun \`shift invariance - mid animation measurement\`() {
        ...
        val midAnimation = computeFabExpandShiftPx(
            nodeBottomInRoot = 2200f + 123f,
            firstItemTopInRoot = 1740f + 123f,
            containerHeightPx = 2000f,
            offsetYPx = -800f,
            topMarginPx = margin,
        )
