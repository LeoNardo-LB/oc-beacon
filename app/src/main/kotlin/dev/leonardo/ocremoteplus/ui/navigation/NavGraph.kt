package dev.leonardo.ocremoteplus.ui.navigation
...
import dev.leonardo.ocremoteplus.SessionDeepLink
...
import dev.leonardo.ocremoteplus.ui.navigation.routes.*
import kotlinx.coroutines.launch
import dev.leonardo.ocremoteplus.ui.screens.about.AboutScreen
...
import dev.leonardo.ocremoteplus.ui.screens.server.ServerSettingsRoute
import dev.leonardo.ocremoteplus.ui.screens.settings.SettingsRoute
import dev.leonardo.ocremoteplus.ui.screens.webview.WebViewScreen
import dev.leonardo.ocremoteplus.ui.screens.workspace.WorkspaceRoute
 ...
 * Nav objects in [dev.leonardo.ocremoteplus.ui.navigation.routes].
 */
...
fun NavGraph(
    ...
    var sharePickerServers by remember { mutableStateOf<List<dev.leonardo.ocremoteplus.domain.model.ServerConfig>>(emptyList()) }
    var sharePickerSessions by remember { mutableStateOf<List<dev.leonardo.ocremoteplus.domain.model.Session>>(emptyList()) }
