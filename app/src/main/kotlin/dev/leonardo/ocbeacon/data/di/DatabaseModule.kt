...
object DatabaseModule {
    ...
    fun provideDatabase(@ApplicationContext context: Context): OcBeaconDatabase =
        ...
        Room.databaseBuilder(context, OcBeaconDatabase::class.java, "ocbeacon.db")
            ...
            .addMigrations(Migrations.MIGRATION_1_2, Migrations.MIGRATION_2_3, Migrations.MIGRATION_3_4, Migrations.MIGRATION_4_5, OcBeaconDatabase.MIGRATION_5_6, Migrations.MIGRATION_6_7, OcBeaconDatabase.MIGRATION_7_8, OcBeaconDatabase.MIGRATION_8_9)
            .build()
