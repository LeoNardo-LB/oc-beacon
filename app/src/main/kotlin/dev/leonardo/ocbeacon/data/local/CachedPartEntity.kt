...
data class CachedPartEntity(
    ...
    val type: String,                    // text/reasoning/tool/shell/step-start/step-finish/file/snapshot/patch/subtask/compaction/retry/abort/agent/permission/question/session-turn/deliverables/unknown（见 MessageStore.typeName；'code' 为历史残留已删）
