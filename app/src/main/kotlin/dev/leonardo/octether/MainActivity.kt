...
import dev.leonardo.octether.ui.navigation.NavGraph
...
class MainActivity : ComponentActivity() {
    ...
    @Inject
    lateinit var fileRepository: dev.leonardo.octether.domain.repository.FileRepository
    ...
    override fun attachBaseContext(newBase: Context) {
        ...
        val languageCode = dev.leonardo.octether.data.repository.SettingsDataStore.getStoredLanguage(newBase)
