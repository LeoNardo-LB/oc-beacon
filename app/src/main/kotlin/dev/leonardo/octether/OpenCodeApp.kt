...
import dev.leonardo.octether.data.repository.DiagnosticLogRepository
import dev.leonardo.octether.logging.AppLogger
import dev.leonardo.octether.service.SessionFocusHolder
import dev.leonardo.octether.util.DebugLogger
...
class OpenCodeApp : Application() {
    ...
    override fun onCreate() {
        ...
        AppLogger.i("App", "OC Tether ${BuildConfig.VERSION_NAME} (code ${BuildConfig.VERSION_CODE}) started")
