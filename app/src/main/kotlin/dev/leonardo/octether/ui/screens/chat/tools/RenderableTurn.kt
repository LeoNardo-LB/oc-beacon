...
fun computeRenderableTurn(
    ...
    isTurnLast: Boolean,
    formatError: (dev.leonardo.octether.domain.model.Message.Assistant.ErrorInfo?) -> String?,
): RenderableTurn {
    ...
    val errorText = ordered.firstNotNullOfOrNull { msg ->
        val am = msg.message as? dev.leonardo.octether.domain.model.Message.Assistant
    ...
    val currentAssistant = currentMessage.message as? dev.leonardo.octether.domain.model.Message.Assistant
