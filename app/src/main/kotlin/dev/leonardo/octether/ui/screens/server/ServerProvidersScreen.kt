package dev.leonardo.octether.ui.screens.server
...
import dev.leonardo.octether.ui.screens.settings.components.SectionHeader
...
fun ServerProvidersScreen(
    ...
    connectProvider?.let { provider ->
        val methods = uiState.authMethods[provider.providerId].orEmpty().ifEmpty {
            listOf(dev.leonardo.octether.data.dto.response.ProviderAuthMethod(type = "api", label = stringResource(R.string.server_settings_auth_method_api)))
        }
