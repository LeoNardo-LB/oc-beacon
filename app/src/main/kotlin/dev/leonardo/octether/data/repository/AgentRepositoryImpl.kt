...
private fun dev.leonardo.octether.data.dto.response.AgentInfo.toDomain() = AgentInfo(
    name = name,
...
private fun dev.leonardo.octether.data.dto.response.CommandInfo.toDomain() = CommandInfo(
    name = name,
    description = description,
    source = source,
    hints = hints,
