...
import dev.leonardo.octether.domain.model.ProviderInfo
...
class ChatInteractionIsolatedTest : BaseChatTest() {
    ...
    fun modelSelector_showsAvailableModels() {
        ...
        val testProvider = ProviderCatalog(
            ...
            name = "Test Provider",
            models = mapOf(
                "model-a" to dev.leonardo.octether.domain.model.ModelCatalog(
                    id = "model-a",
                    name = "Model A",
                    contextWindow = 128000
                ),
                "model-b" to dev.leonardo.octether.domain.model.ModelCatalog(
                    id = "model-b",
                    name = "Model B",
