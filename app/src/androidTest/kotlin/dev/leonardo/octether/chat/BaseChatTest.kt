...
import dev.leonardo.octether.builder.aSession
...
abstract class BaseChatTest {
    ...
    @Inject lateinit var sessionStateService: dev.leonardo.octether.data.repository.SessionStateService
    @Inject lateinit var tokenStatsTracker: dev.leonardo.octether.domain.tracker.TokenStatsTracker
